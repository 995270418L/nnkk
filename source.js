var x = {
    ...
    gd: function () {
        var a = bmak['uar'](), t = '' + bmak['ab'](a), e = bmak['start_ts'] / 2,
    ...
    bc: function () {
        var a = window['addEventListener'] ? 1 : 0, t = window['XMLHttpRequest'] ? 1 : 0,
            e = window['XDomainRequest'] ? 1 : 0, n = window['emit'] ? 1 : 0,
            o = window['DeviceOrientationEvent'] ? 1 : 0, m = window['DeviceMotionEvent'] ? 1 : 0,
            r = window['TouchEvent'] ? 1 : 0, i = window['spawn'] ? 1 : 0, c = window['innerWidth'] ? 1 : 0,
            b = window['outerWidth'] ? 1 : 0, d = window['chrome'] ? 1 : 0, k = Function['prototype']['bind'] ? 1 : 0,
            s = window['Buffer'] ? 1 : 0, l = window['PointerEvent'] ? 1 : 0;
    ...
    bd: function () {
        var a = [], t = window['callPhantom'] ? 1 : 0;
        a['push'](',cpen:' + t);
        try {
    ...
    cma: function (a, t) {
        try {
            if (1 == t && bmak['mme_cnt'] < bmak['mme_cnt_lmt'] || 1 != t && bmak['mduce_cnt'] < bmak['mduce_cnt_lmt']) {
                ...
                var m = e['toElement'];
                null == m && (m = e['target']);
                var r = bmak['gf'](m), i = bmak['get_cf_date']() - bmak['start_ts'],
                ...
                c += ';', bmak['me_vel'] = bmak['me_vel'] + bmak['me_cnt'] + t + i + n + o, bmak['mact'] = bmak['mact'] + c, bmak['ta'] += i
            }
    ...
    x2: function () {
        var a = bmak['ff'], t = a(98) + a(109) + a(97) + a(107) + a(46) + a(103) + a(101) + a(116);
        ...
        try {
            ...
            if (1 == t && bmak['pme_cnt'] < bmak['pme_cnt_lmt'] || 1 != t && bmak['pduce_cnt'] < bmak['pduce_cnt_lmt']) {
                ...
                if (n && 'mouse' != n['pointerType']) {
                    ...
                    bmak['pe_vel'] = bmak['pe_vel'] + bmak['pe_cnt'] + t + r + o + m, bmak['pact'] = bmak['pact'] + i, bmak['ta'] += r, 1 == t ? bmak['pme_cnt']++ : bmak['pduce_cnt']++
                }
            }
    ...
    to: function () {
        ...
        for (var t = a, e = 0; e < 5; e++) {
            var n = bmak['pi'](a / Math['pow'](10, e)) % 10, o = n + 1, m = 'return a' + bmak['cc'](n) + o + ';';
        ...
        try {
            ...
            if (bmak['ke_cnt'] < bmak['ke_cnt_lmt'] && e) {
                ...
                var m = e['charCode'], r = e['shiftKey'] ? 1 : 0, i = e['ctrlKey'] ? 1 : 0, c = e['metaKey'] ? 1 : 0,
                    ...
                    k = bmak['get_cf_date']() - bmak['start_ts'], s = bmak['gf'](null), l = 0;
                ...
                if (0 == bmak['isIgn'](n)) {
                    ...
                    null != e['isTrusted'] && !1 === e['isTrusted'] && (u += ',0'), u += ';', bmak['kact'] = bmak['kact'] + u, bmak['ke_vel'] = bmak['ke_vel'] + bmak['ke_cnt'] + t + k + n + d + s, bmak['ta'] += k
                } else o = 0
            }
    ...
    cta: function (a, t) {
        try {
            if (1 == t && bmak['tme_cnt'] < bmak['tme_cnt_lmt'] || 1 != t && bmak['tduce_cnt'] < bmak['tduce_cnt_lmt']) {
                ...
                bmak['tact'] = bmak['tact'] + r, bmak['ta'] += m, bmak['te_vel'] = bmak['te_vel'] + bmak['te_cnt'] + t + m + n + o, bmak['doa_throttle'] = 0, bmak['dma_throttle'] = 0
            }
    ...
    cdoa: function (a) {
        try {
            if (bmak['doe_cnt'] < bmak['doe_cnt_lmt'] && bmak['doa_throttle'] < 2 && a) {
                var t = bmak['get_cf_date']() - bmak['start_ts'], e = bmak['getFloatVal'](a['alpha']),
                    n = bmak['getFloatVal'](a['beta']), o = bmak['getFloatVal'](a['gamma']),
                    m = bmak['doe_cnt'] + ',' + t + ',' + e + ',' + n + ',' + o + ';';
                bmak['doact'] = bmak['doact'] + m, bmak['ta'] += t, bmak['doe_vel'] = bmak['doe_vel'] + bmak['doe_cnt'] + t, bmak['doe_cnt']++
            }
    ...
    cdma: function (a) {
        try {
            if (bmak['dme_cnt'] < bmak['dme_cnt_lmt'] && bmak['dma_throttle'] < 2 && a) {
                var t = bmak['get_cf_date']() - bmak['start_ts'], e = -1, n = -1, o = -1;
                ...
                bmak['dmact'] = bmak['dmact'] + k, bmak['ta'] += t, bmak['dme_vel'] = bmak['dme_vel'] + bmak['dme_cnt'] + t, bmak['dme_cnt']++
            }
    ...
    forminfo: function () {
        for (var a = '', t = '', e = document['getElementsByTagName']('input'), n = -1, o = 0; o < e['length']; o++) {
            var m = e[o], r = bmak['ab'](m['getAttribute']('name')), i = bmak['ab'](m['getAttribute']('id')),
                c = m['getAttribute']('required'), b = null == c ? 0 : 1, d = m['getAttribute']('type'),
                k = null == d ? -1 : bmak['get_type'](d), s = m['getAttribute']('autocomplete');
    ...
    cfsubmit: function () {
        bmak['sd_debug']('<cfsubmit/>'), bmak['js_post'] ? (bmak['aj_type'] = 4, bmak['bpd'](), 0 == bmak['ce_js_post'] && bmak['cns'] != bmak['ins'] && bmak['pd'](!0)) : bmak['bpd']()
    },
    getdurl: function () {
    ...
    cookie_chk_read: function (a) {
        if (document['cookie']) for (var t = a + '=', e = document['cookie']['split']('; '), n = 0; n < e['length']; n++) {
            var o = e[n];
            if (0 === o['indexOf'](t)) {
    ...
    bpd: function () {
        ...
        try {
            a = bmak['get_cf_date']();
            var t = bmak['updatet'](), e = '3';
            bmak['ckie'] && (e = bmak['get_cookie']());
            var n = bmak['gd'](), o = window['DeviceOrientationEvent'] ? 'do_en' : 'do_dis',
                m = window['DeviceMotionEvent'] ? 'dm_en' : 'dm_dis', r = window['TouchEvent'] ? 't_en' : 't_dis',
                i = o + ',' + m + ',' + r, c = bmak['forminfo'](), b = bmak['getdurl'](),
            ...
            var k = bmak['ke_vel'] + bmak['me_vel'] + bmak['doe_vel'] + bmak['dme_vel'] + bmak['te_vel'] + bmak['pe_vel'],
                s = bmak['get_cf_date']() - bmak['start_ts'], l = bmak['pi'](bmak['d2'] / 6), u = bmak['fas'](),
        ...
        try {
            var g = bmak['od'](bmak['cs'], bmak['api_public_key'])['slice'](0, 16),
                w = Math['floor'](bmak['get_cf_date']() / 36e5), y = bmak['get_cf_date'](),
                C = g + bmak['od'](w, g) + bmak['sensor_data'];
            bmak['sensor_data'] = C + ';' + (bmak['get_cf_date']() - a) + ';' + bmak['tst'] + ';' + (bmak['get_cf_date']() - y)
        } catch (a) {
        }
        try {
            if (0 == bmak['sdfn']['length']) bmak['sd_debug'](',s4'), document['getElementById']('sensor_data') && (bmak['sd_debug'](',s5'), document['getElementById']('sensor_data')['value'] = bmak['sensor_data']); else {
                bmak['sd_debug'](',s6:');
                for (var j = 0; j < bmak['sdfn']['length']; j++) if (bmak['sd_debug'](',a-' + bmak['sdfn'][j]), document['getElementById'](bmak['sdfn'][j])) {
                    bmak['sd_debug'](',b'), document['getElementById'](bmak['sdfn'][j])['value'] = bmak['sensor_data'];
        ...
        try {
            ...
            if (n > 0) {
                for (var o = 0; o < a['length']; o++) {
                    var m = a['charCodeAt'](o), r = a['charAt'](o), i = t['charCodeAt'](o % n);
    ...
    lvc: function (a) {
        try {
            if (bmak['vc_cnt'] < bmak['vc_cnt_lmt']) {
                var t = bmak['get_cf_date']() - bmak['start_ts'], e = a + ',' + t + ';';
    ...
    mn_get_challenge: function () {
        var a = bmak['get_mn_params_from_abck'](), t = a[0], e = a[1], n = a[2], o = a[3], m = a[4], r = a[5];
        bmak['mn_abck'] = e, bmak['mn_psn'] = n['toString'](), bmak['mn_sen'] = t, bmak['mn_cd'] = o, bmak['mn_tout'] = m, bmak['mn_stout'] = r, bmak['mn_ts'] = bmak['start_ts'], bmak['mn_cc'] = bmak['mn_abck'] + bmak['start_ts'] + bmak['mn_psn']
    },
    ...
    mn_h: function (a) {
        var t = 1732584193, e = 4023233417, n = 2562383102, o = 271733878, m = 3285377520, r = bmak['encode_utf8'](a),
            i = 8 * r['length'];
    ...
    mn_w: function () {
        try {
            for (var a = 0, t = 0, e = 0, n = '', o = bmak['get_cf_date'](), m = bmak['mn_cd'] + bmak['mn_mc_indx']; 0 == a;) {
                ...
                var r = bmak['mn_cc'] + m['toString']() + n, i = bmak['mn_h'](r);
                if (0 == bmak['bdm'](i, m)) a = 1, e = bmak['get_cf_date']() - o, bmak['mn_al']['push'](n), bmak['mn_tcl']['push'](e), bmak['mn_il']['push'](t), 0 == bmak['mn_mc_indx'] && (bmak['mn_lg']['push'](bmak['mn_abck']), bmak['mn_lg']['push'](bmak['mn_ts']), bmak['mn_lg']['push'](bmak['mn_psn']), bmak['mn_lg']['push'](bmak['mn_cc']), bmak['mn_lg']['push'](bmak['mn_cd']['toString']()), bmak['mn_lg']['push'](m['toString']()), bmak['mn_lg']['push'](n), bmak['mn_lg']['push'](r), bmak['mn_lg']['push'](i)); else if ((t += 1) % 1e3 == 0 && (e = bmak['get_cf_date']() - o) > bmak['mn_stout']) return void setTimeout(bmak['mn_w'], 1e3 + bmak['mn_stout'])
            }
            bmak['mn_mc_indx'] += 1, bmak['mn_mc_indx'] < bmak['mn_mc_lmt'] ? setTimeout(bmak['mn_w'], bmak['mn_tout'] + e) : (bmak['mn_mc_indx'] = 0, bmak['mn_state'] = 0, bmak['mn_lc'] = bmak['mn_cc'], bmak['mn_ld'] = bmak['mn_cd'], bmak['mn_r'] = bmak['mn_pr']())
        } catch (a) {
    ...
    listFunctions: {
        _setJsPost: function (a) {
            ...
            bmak['bm'] = a, bmak['bm'] && (bmak['cf_url'] = (bmak['fsp'] ? 'https:' : document['location']['protocol']) + '//' + document['location']['hostname'] + '/_bm/_data', bmak['api_public_key'] = 'afSbep8yjnZUjq3aL010jO15Sawj2VZfdYK8uY90uxq', bmak['js_post'] = !0, bmak['enReadDocUrl'] = 1, bmak['runFonts'] = !1)
        }, _setAu: function (a) {
...
bmak['sd_debug']('<setSDFN>' + bmak['sdfn']['join']() + '</setSDFN>'), _cf = {push: bmak['applyFunc']}, function (a) {
    var t = {};
    a['fpcf'] = t, t['sf4'] = function () {
        ...
        var a = screen['colorDepth'] ? screen['colorDepth'] : -1, e = screen['pixelDepth'] ? screen['pixelDepth'] : -1,
            n = navigator['cookieEnabled'] ? navigator['cookieEnabled'] : -1,
            o = navigator['javaEnabled'] ? navigator['javaEnabled']() : -1,
            m = navigator['doNotTrack'] ? navigator['doNotTrack'] : -1, r = 'default';
        return r = bmak['runFonts'] ? bmak['altFonts'] ? t['fonts_optm']() : t['fonts']() : 'dis', [t['canvas'](), r, t['pluginInfo'](), t['sessionStorageKey'](), t['localStorageKey'](), t['indexedDbKey'](), t['timezoneOffsetKey'](), t['webrtcKey'](), a, e, n, o, m]['join'](';')
        ...
        try {
            ...
            if (!t['sf4']()) {
                ...
                if (e['width'] = 280, e['height'] = 60, e['style']['display'] = 'none', 'function' == typeof e['getContext']) {
                    ...
                    i['font'] = '6pt Arial', t['rVal'] = Math['floor'](1e3 * Math['random']())['toString'](), i['fillText'](t['rVal'], 1, 12);
        ...
        var a = 200, e = bmak['get_cf_date'](), n = [];
        if (!t['sf4']()) {
        ...
        var a = [];
        if (!t['sf4']()) {
            var e = ['serif', 'sans-serif', 'monospace'], n = [0, 0, 0], o = [0, 0, 0],
...
try {
    bmak['ir'](), bmak['t_tst'] = bmak['get_cf_date'](), bmak['startTracking'](), bmak['tst'] = bmak['get_cf_date']() - bmak['t_tst'], bmak['disFpCalOnTimeout'] || setTimeout(bmak['fpcf']['fpVal'], 100);
